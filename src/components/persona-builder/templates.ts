  ...
  // ── 1. Developer Dark ────────────────────────────────────────────────────────
  {
    ...
    elements: [
      ...
      el('d-skillbg', 'section', 0, 556, 1440, 404, '',
        { backgroundColor: '#161b22', border: '1px solid #21262d' }, { zIndex: 1, sectionKey: 'skills' }),
      ...
      el('d-proj1', 'paragraph', 100, 814, 360, 124,
       ...
       { backgroundColor: '#1f2937', borderRadius: 12, border: '1px solid #374151', padding: 16, color: '#c9d1d9', fontSize: 12, lineHeight: 1.6 }, { zIndex: 2, sectionKey: 'projects' }),
  ...
  // ── 3. Personal Warm ─────────────────────────────────────────────────────────
  {
    ...
    elements: [
      el('pw-leftbg', 'section', 0, 0, 580, 960, '',
        { backgroundColor: '#fff8f0', border: '1px solid #fed7aa' }, { zIndex: 0 }),
      ...
      el('pw-posts-h', 'heading', 650, 60, 360, 48, 'Latest Posts',
        ...
        { headingLevel: 2, zIndex: 2, sectionKey: 'blog' }),
      ...
      el('pw-contact-h', 'heading', 650, 526, 360, 44, 'Get in Touch',
        ...
        { headingLevel: 2, zIndex: 2, sectionKey: 'contact' }),
  ...
  // ── 5. Creative Studio ───────────────────────────────────────────────────────
  {
    ...
    elements: [
      ...
      el('cs-svcbg', 'section', 0, 560, 1440, 400, '',
       { backgroundColor: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }, { zIndex: 1, sectionKey: 'services' }),
  ...
  // ── 6. Photography ───────────────────────────────────────────────────────────
  {
    ...
    elements: [
      ...
      el('ph-hero', 'image', 0, 64, 880, 572,
        ...
        { objectFit: 'cover' },  { zIndex: 2, sectionKey: 'portfolio' }),
      el('ph-side1', 'image', 896, 64, 544, 274,
        'https://placehold.co/544x274/222222/6b7280?text=Series+01',
        { objectFit: 'cover' }, { zIndex: 2, sectionKey: 'series' }),
      ...
      el('ph-contact', 'paragraph', 920, 640, 480, 128,
        ...
        { backgroundColor: '#141414', border: '1px solid #262626', borderRadius: 12, padding: 24, color: '#9ca3af', fontSize: 14, lineHeight: 1.8 }, { zIndex: 3, sectionKey: 'contact' }),
    ],
  },
]

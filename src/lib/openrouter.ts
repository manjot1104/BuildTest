...
export async function generateLaTeXResume(data: ResumeData): Promise<OpenRouterResult> {
  ...
  // For LaTeX, we'll use inline instructions in the prompt when no template is selected
  const designInstructions = ''
  
  // Template style guide (if template is selected)
  const templateGuide = (data as any).templateStyleGuide
    ? `\n\n
╔═══════════════════════════════════════════════════════════════════════════════╗
║                                                                               ║
...
${(data as any).templateStyleGuide}
